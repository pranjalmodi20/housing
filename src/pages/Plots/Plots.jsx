...
import { LandPlot, Home, Trees, TrendingUp, ArrowRight, Maximize, IndianRupee, MapPin } from 'lucide-react';
      ...
      <section className="relative bg-gradient-to-b from-emerald-900 via-emerald-800 to-primary-900 pt-28 pb-14 sm:pt-32 sm:pb-16 overflow-hidden text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 leading-tight"><span className="text-white">Buy</span> <span className="bg-gradient-to-r from-emerald-300 to-primary-300 bg-clip-text text-transparent">Plots & Land</span></h1>
